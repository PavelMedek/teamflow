...
import NeonDbLogo from "@/public/neondb.png";
import OrpcLogo from "@/public/orpc.webp";
import PrismaLogo from "@/public/prisma-logo.svg";
import MotionLogo from "@/public/motion-logo.png";
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  The AI-ready home for team collaboration
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
            ...
            >
              <div className="mask-b-from-55% relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  ...
                  />
                  <Image
                    className="z-2 border-border/25 aspect-15/8 relative rounded-2xl border dark:hidden object-contain object"
                    src={HeroLight}
                    alt="app screen"
                    width="2700"
                    height="1440"
